...
bool FGInitialCondition::Load_v2(Element* document)
{
    ...
    if (frame == "eci") { // Need to transform vLoc to ECEF for storage and use in FGLocation.
      ...
      if (!position_el->FindElement("x") && !position_el->FindElement("y") && !position_el->FindElement("z")) {
        ...
        if (position_el->FindElement("radius")) {
          ...
          FGXMLLogging log(position_el, LogLevel::ERROR);
  ...
  if (orientation_el) {
    ...
    if (frame == "eci") {
      ...
      FGXMLLogging log(orientation_el, LogLevel::ERROR);
  ...
  if (velocity_el) {
    ...
    if (frame == "eci") {
      ...
      FGXMLLogging log(velocity_el, LogLevel::ERROR);
  ...
  if (attrate_el) {
    ...
    if (frame == "eci") {
      ...
      FGXMLLogging log(attrate_el, LogLevel::ERROR);
